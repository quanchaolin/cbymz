...
class Wechat
{
    ...
    const MEDIA_UPLOAD_URL = '/media/upload?';//临时素材上传接口
    const MEDIA_UPLOADIMG_URL = '/media/uploadimg?';//logo上传接口
    const MEDIA_GET_URL = '/media/get?';//获取临时素材接口
...
<Nonce><![CDATA[%s]]></Nonce>
    ...
    protected function setCache($cachename,$value,$expired){
        ...
        /*$ci=&get_instance();
        $ci->load->model('access_token_model', 'access_token');
        $ci->access_token->set($cachename, array(
                'cachename'=>$cachename,
                'value' => $value,
    ...
    protected function getCache($cachename){
        ...
        /*$ci=&get_instance();
        $ci->load->model('access_token_model', 'access_token');
        $data = $ci->access_token->get($cachename);
    ...
    protected function removeCache($cachename){
        ...
        /*$ci=&get_instance();
        $ci->load->model('access_token_model', 'access_token');
        $ci->access_token->remove($cachename);*/
        return false;
    }
    /**
     * 获取access_token
