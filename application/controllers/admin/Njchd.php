...
class Njchd extends Content
{
    ...
    function __construct()
    {
        $this->name = '念经超度';
        $this->control = 'njchd';
        $this->list_view = 'njchd_list'; // 列表页
        $this->add_view = 'njchd_add'; // 添加页
        parent::__construct();
        $this->baseurl = site_url('admin/njchd/');
    ...
    public function export()
    {
        ...
        $data['list']=$list;
        $this->load->view('admin/njchd_export',$data);
    }
}
