...
<div class="page-group">
    ...
    <div class="popup popup-buy">
        ...
        <div class="content native-scroll">
            ...
            <div class="gw_num">
                <em class="jian">-</em>
                <input type="number" value="<?php if($value['min_price']!=1){echo $value['min_price'];}?>" class="num"/>
                <em class="add">+</em>
            </div>
                    ...
                    <div class="list-block" style="margin: 0.4rem 0;">
                        <ul>
                            ...
                            <li>
                                <div class="item-content">
                                    <div class="item-inner">
                                        <p style="color:#7b0c00;font-size: 0.85rem;">【温馨提示】600元最多只能写三位信众的名字，超过的寺院仅默认前面三位的名字，感恩周知</p>
                                    </div>
                                </div>
                            </li>
                        </ul>
