...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?=$this->baseurl?>">祈福消灾心愿单</a></li>
...
<div class="modal fade" id="dialog-export-form">
    <div class="modal-dialog">
        <form class="table-responsive" action="<?=site_url('admin/qfxz/export?start_time=')?>" method="get" id="Form" data-parsley-validate>
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title">祈福消灾导出</h4>
                </div>
