...
// 设置属性
$objPHPExcel->getProperties()->setCreator('祈福消灾心愿单');
$objPHPExcel->getProperties()->setLastModifiedBy('祈福消灾心愿单');
...
$objPHPExcel->getActiveSheet()->SetCellValue('G1','其他信息');
...
// Rename sheet
$objPHPExcel->getActiveSheet()->setTitle('祈福消灾心愿单');
...
header("Content-Disposition:attachment;filename=祈福消灾心愿单$date.xls");
