<?php $this->load->view('admin/header'); ?>
                            ...
                            <tr>
                                <td width="98%" class="news-list">
                                    <div class="layui-form-item">
                                        <label class="layui-form-label">* 标题</label>
                                        <div class="layui-input-inline">
                                            <input type="text" name="title" class="layui-input news_title" value="<?= $back_paper_item['title'] ?>">
                                        </div>
                                    </div>
                                    <div class="layui-form-item">
                                        <label class="layui-form-label">* 封面图片链接</label>
                                        <div class="layui-input-inline">
                                            <input type="text" name="picurl" class="layui-input" value="<?= $back_paper_item['picurl'] ?>">
                                        </div>
                                    </div>
                                    <div class="layui-form-item">
                                        <label class="layui-form-label">* 跳转的链接</label>
                                        <div class="layui-input-inline">
                                            <input type="text" name="url"  class="layui-input" value="<?= $back_paper_item['url'] ?>">
                                        </div>
                                    </div>
                                    <div class="layui-form-item">
                                        <label class="layui-form-label">* 详情页图片</label>
                                        <div class="layui-input-inline">
                                            <input type="text" name="thumb" class="layui-input" value="<?= $back_paper_item['thumb'] ?>">
                                        </div>
                                        <button type="button" class="layui-btn btn-upload-detail-img"><i class="fa fa-cloud-upload" aria-hidden="true"></i>上传</button>
                                    </div>
                                    <div class="layui-form-item">
                                        <label class="layui-form-label">消息的描述</label>
                                        <div class="layui-input-block">
                                            <textarea name="description" class="layui-textarea" style="width: 480px;"><?= $back_paper_item['description'] ?></textarea>
                                        </div>
                                    </div>
                                </td>
                                <td>
    ...
    <script>
        layui.use(['upload','layer','element'], function(){
            ...
            //普通图片上传
            upload.render({
                elem: '.btn-upload-detail-img'
                ,url: '<?=site_url('admin/file/image_upload/')?>'
                ,done: function(res){
                    console.log(this);
                ...
                $("#news_submit").on('click',function(){
                    ...
                    $(".news-list").each(function(){
                        var divs=$(this).children(),
                            ...
                            thumb=divs.eq(3).find("input").val(),
                            description=divs.eq(4).find("textarea").val();
                        var arr={item_title:item_title,picurl:picurl,item_url:item_url,thumb:thumb,description:description};
                        if(item_title!='')
                        {
                            list.push(arr);
                        }
