    ...
    <div style="margin:0 10px;">
        ...
        <table class="layui-table">
            ...
            <?php foreach ($list as $key => $value): ?>
                <tr>
                    <td><input type="radio" name="choose" value="<?= $value['media_id'] ?>" title="选择"></td>
                    <td>
                        <a href="<?=$value['url']?>" target="_blank">
                            <img src="<?=$value['url']?>" width="64" height="64">
                        </a>
                    </td>
                    <td><?= $value['name'] ?></td>
                </tr>
    ...
    <script>
        ...
        layui.use(['jquery'], function () {
            ...
            $('#transmit').on('click', function(){
                ...
                {
                    parent.document.getElementById('image').value=media_id;
                }
