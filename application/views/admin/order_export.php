...
// 设置属性
$objPHPExcel->getProperties()->setCreator('心愿单');
$objPHPExcel->getProperties()->setLastModifiedBy('心愿单');
...
// Rename sheet
$objPHPExcel->getActiveSheet()->setTitle('心愿单');
...
header("Content-Disposition:attachment;filename=心愿单$date.xls");
