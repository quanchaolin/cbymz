...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?=$this->baseurl?>">广种福田心愿单</a></li>
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <th width="10%">用户昵称</th>
                                <th width="10%">项目名称</th>
                                <th width="15%">超度往生者姓名</th>
                                <th>功德主所求愿望</th>
                                <th width="15%">功德主名字</th>
                                <th width="8%">联系电话</th>
                                <th width="8%">总共</th>
                                <th width="10%">添加时间</th>
                            </tr>
...
<div class="modal fade" id="dialog-export-form">
    <div class="modal-dialog">
        <form class="table-responsive" action="<?=site_url('admin/njchd/export?start_time=')?>" method="get" id="Form" data-parsley-validate>
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title">念经超度导出</h4>
                </div>
