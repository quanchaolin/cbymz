    ...
    <div class="popup popup-buy">
        ...
        <div class="content native-scroll">
            ...
            <div class="content-inner">
                                ...
                                <div class="item-content">
                                    <div class="item-inner">
                                        <div class="item-input">
                                            <textarea id="other_name" placeholder="<?=$value['remark']?>"><?=$order['other_name']?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </li>
                ...
                <img src="<?=base_url('uploads/image/20161108/201611081010.jpg')?>" width="100%">
...
<script>
    ...
    $(document).ready(function(){
        ...
        $(document).on('click','#submit',function(){
            ...
            if(other_name=='') {$.alert('请填写考试学子信息');return false;}
